...
!function(a, b) {
    ...
    var t = function(a) {
        ...
        c = fa.support = {}, f = fa.isXML = function(a) {
            ...
            c.matchesSelector && p && !A[b + " "] && (!r || !r.test(b)) && (!q || !q.test(b))) try {
                var d = s.call(a, b);
                ...
                CHILD: function(a, b, c, d, e) {
                    ...
                    return 1 === d && 0 === e ? function(a) {
                        ...
                        if (q) {
                            ...
                            k = l[m.uniqueID] || (l[m.uniqueID] = {}), k[a] = [ w, t ]), 
                            m === b)) break;
    ...
    function ca(a, b, c, d, e) {
        ...
        f || 0 === f) if ("object" === n.type(f)) n.merge(m, f.nodeType ? [ f ] : f); else if (ba.test(f)) {
            ...
            i = $[h] || $._default, g.innerHTML = i[1] + n.htmlPrefilter(f) + i[2], 
            k = i[0];
    ...
    n.event = {
        ...
        fix: function(a) {
            ...
            e = h.props ? this.props.concat(h.props) : this.props, a = new n.Event(g), 
            b = e.length;
        ...
        this.type = a.type, this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && a.returnValue === !1 ? ga : ha) : this.type = a, 
    ...
    !function() {
        ...
        if (h.style) {
            ...
            function i() {
                ...
                h.style.marginRight = "50%", e = "4px" === d.marginRight, Ea.removeChild(g);
            }
            n.extend(l, {
                ...
                reliableMarginRight: function() {
                    ...
                    c.style.marginRight = c.style.width = "0", h.style.width = "1px", 
                    Ea.appendChild(g), b = !parseFloat(a.getComputedStyle(c).marginRight), 
    ...
    function Fa(a, b, c) {
        ...
        e = h.minWidth, f = h.maxWidth, h.minWidth = h.maxWidth = h.width = g, g = c.width, 
    ...
    n.extend({
        ...
        css: function(a, b, c, d) {
            ...
            return b = n.cssProps[h] || (n.cssProps[h] = Ma(h) || h), g = n.cssHooks[b] || n.cssHooks[h], 
            g && "get" in g && (e = g.get(a, !0, c)), void 0 === e && (e = Fa(a, b, d)), 
            "normal" === e && b in Ja && (e = Ja[b]), "" === c || c ? (f = parseFloat(e), 
    ...
    function Za(a, b, c) {
        ...
        c.queue || (h = n._queueHooks(a, "fx"), null == h.unqueued && (h.unqueued = 0, 
        ...
        if (n.isEmptyObject(m)) "inline" === ("none" === j ? za(a.nodeName) : j) && (o.display = j); else {
            ...
            for (d in m) g = Ya(p ? q[d] : 0, d, l), d in q || (q[d] = g.start, 
    ...
    function $a(a, b) {
        ...
        f = a[c] = f[0]), c !== d && (a[d] = f, delete a[c]), g = n.cssHooks[d], 
        g && "expand" in g) {
    ...
    n.fn.extend({
        ...
        removeAttr: function(a, b) {
            ...
            n.expr.match.bool.test(c) && (a[d] = !1), a.removeAttribute(c);
        }
    }), ab = {
        set: function(a, b, c) {
    ...
    n.extend(n.event, {
        trigger: function(b, c, e, f) {
            ...
            o = n.event.special[q] || {}, f || !o.trigger || o.trigger.apply(e, c) !== !1)) {
                ...
                m = l && h[l], m && m.apply && L(h) && (b.result = m.apply(h, c), 
                ...
                i && (e[l] = null), n.event.triggered = q, e[q](), n.event.triggered = void 0, 
                i && (e[l] = i)), b.result;
            }
        },
    ...
    n.extend({
        ...
        ajax: function(b, c) {
            ...
            function z(b, c, d, h) {
                ...
                d && (u = zb(m, x, d)), u = Ab(m, u, x, j), j ? (m.ifModified && (w = x.getResponseHeader("Last-Modified"), 
                w && (n.lastModified[f] = w), w = x.getResponseHeader("etag"), w && (n.etag[f] = w)), 
                204 === b || "HEAD" === m.type ? y = "nocontent" : 304 === b ? y = "notmodified" : (y = u.state, 
                l = u.data, t = u.error, j = !t)) : (t = y, !b && y || (y = "error", 
                0 > b && (b = 0))), x.status = b, x.statusText = (c || y) + "", 
    ...
    n.offset = {
        ...
        position: function() {
            if (this[0]) {
                ...
                b = this.offset(), n.nodeName(a[0], "html") || (d = a.offset()), 
    ...
    return n.noConflict = function(b) {
        return a.$ === n && (a.$ = Ob), b && a.jQuery === n && (a.jQuery = Nb), 
        n;
    }, b || (a.jQuery = a.$ = n), n;
});